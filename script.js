...
// Función para dibujar el recuadro de señal
function drawBoundingBox(x, y, width, height, className) {
    var div = document.createElement("div");
    div.className = "bounding-box " + className;
    div.style.left = x + "px";
    div.style.top = y + "px";
...
// Función para limpiar los recuadros de señales anteriores
...
// Llamamos a esta función después de obtener las predicciones
function displayPredictions(predictions) {
    clearBoundingBoxes(); // Limpiamos los recuadros de señales anteriores
    for (var i = 0; i < predictions.length; i++) {
        var prediction = predictions[i];
        drawBoundingBox(
            prediction.bbox.x,
